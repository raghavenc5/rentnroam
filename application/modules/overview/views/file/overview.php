...
<link rel="stylesheet" href="<?php echo base_url()?>public/temp_overview/css/default.css" type="text/css" />	
	...
	<?php
                                    ...
                                    $baseUrl = 'http://localhost/rent_n_roam/trunk/rentnroam/overview/OverviewProperty/property_id/29';                    
			...
			<div class="centered-content">
				...
				<div class="grid-row">
					...
					<div class="amenities-cell equal-heights2">
						<h2>Amenities</h2>
						<?php
						echo '<a href="#" class="more">more +</a>';
						echo '<table>';
						echo '<tr>';
						foreach($jsonDataObject->amenities as $option){		
					//		array_push($object_array, $value);
							echo '<th>'.$option->rnr_amenities_type.'</th>';																						
						}
					//$object_unique = array_unique($object_array);
					//foreach ($object_unique as $key => $value1) {
     				//echo '<th>'.$value1.'</th>';
					//}
					...
					foreach($jsonDataObject->amenities as $option){		
							...
							echo '<td><image src="'.$option->image_path.'"/></td>';	
					...
					<div class="price-cell equal-heights3">
						...
						<table>
							<tr>
								...
								<td><?php echo $jsonDataObject->prices->guest_charge; ?> / night after the first guest</td>
							</tr>
							<tr>
								<td>Security Deposit:</td>
								<td>₹ <?php echo $jsonDataObject->prices->security_deposit; ?></td>
							</tr>
							<tr>
								<td>Weekly Price:</td>
								<td>₹ <?php echo $jsonDataObject->prices->seasonalPrices->weeklyPrice; ?> /week</td>
							</tr>
							<tr>
								<td>Monthly Price:</td>
								<td>₹ <?php echo $jsonDataObject->prices->seasonalPrices->monthlyPrice; ?> /month</td>
							</tr>
						</table>
					</div><!-- end price-cell -->
				...
				<div class="centered-content group">
					...
					<div class="about-host">
						...
						<div class="host-details">
							...
							<span class="member-since">Member since, October 2011</span><!-- end member-since -->
