			...
			<div class="modal-body">
				<div class="row">
					...
					<div class="alert alert-error" id="validation_error" style="display: none">						
						...
						<p class="signUpLink">Not a member?<a href="#"> SIGN UP</a></p>
					</form>
				</div><!-- /.row -->
			</div>
		</div>
...
{  
	...
	if(error_flag != 1) 
	{
		$.post(BASE_URL+'overview/doLogin',
		{
			'email_id' : email_id,
			'password' : password
		},
		function(data)
		{
			...
			//	window.location = BASE_URL+"overview/index";
				//var page= window.location+"overview/index/"
