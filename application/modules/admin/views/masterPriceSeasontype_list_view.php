...
<div id="overlayEditSeasontype" tabindex="-1">
     <div>
          <p>Edit Master Policy</p>
          
          <form id="submitEditSeasontype">
			<table>
	            ...
	            <tr><td>
	            <input type="submit" id="EditSeasonButton" value="Update">
	           </td></tr>
           </table>
          </form>          
          <a href="#" id="EditCloseSeason">close</a>
     </div>    
</div>
...
<div>
	<ul class="breadcrumb">
		...
		<li>
			<a href="javascript:void(0)">Master Price Seasontype</a>
		</li>
	</ul>
</div>
...
<div class="row-fluid sortable">	
	<div class="box span12">
			...
			<ul>
				<li>
				<a href="<?php echo base_url().index_page()?>admin/master_location/indexPriceSeasontype">Master Price Season Type </a> 
				</li>
		...
		<div class="box-content">					
			<table class="table table-bordered table-striped table-condensed">
					<thead>
						<tr>
							<th><a href="#">No.</a></th>
							<th><a href="<?php echo base_url().index_page().'admin/master_location/indexPriceSeasontype/season_type/'.$sortOrder?>">Season Type <i class="<?php echo ($sortOrder == 'ASC') ? 'icon-chevron-down' : 'icon-chevron-up'?>"></i></a></th>
					...
					<?php echo $this->load->view('admin/masterSeasontype_list');?>
				</tbody>					
			 </table>
			 ...
			 <div id="cityformdiv">
			 	<form id="formSeason">
			 		<ul>
			 			<li>    				
							<input type="text" name="season" placeholder="Season" id="season">    
	             		</li>
			 			
			 		</ul>
			 		<input type="submit" id="addSeason" name="submit" value="Submit">
			 	</form>
			 </div>
		<div class="box-content">
