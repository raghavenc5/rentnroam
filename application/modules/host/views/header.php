...
<html lang="en">
    <head>
        ...
        <?php
        if ('host' == $this->router->class && in_array($this->router->method, array('propertylisting', 'editproperty'))) {
        ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" id="sub-nav">
                        <div class="centered-content">
                            ...
                            <div class="col-md-1">
                                <p><a href="<?php echo site_url('/host/profile/mybookings'); ?>">my bookings</a></p>
                            </div>
