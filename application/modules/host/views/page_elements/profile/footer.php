<div class="footer">
                  ...
                  <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                      <div class="footer-box-big">
                          ...
                          <ul class="list-inline social-list padding-top-10">
                              ...
                              <li><a href="#"><span class="twitter social-box"><img src="<?php echo base_url()?>public/images/social.png"></span></a></li>
                              <li><a href="#"><span class="fb social-box"><img src="<?php echo base_url()?>public/images/social.png"></span></a></li>
                              <li><a href="#"><span class="rss social-box"><img src="<?php echo base_url()?>public/images/social.png"></span></a></li>
                              <li><a href="#"><span class="g-plus social-box"><img src="<?php echo base_url()?>public/images/social.png"></span></a></li>
                          </ul>
                      </div>
                  </div>
              </div>
      ...
      <div id="bookingModal" class="modal fade calendar-modal">
          <div class="modal-dialog">
              <div class="modal-content">
                  <div class="modal-body">
                      <form class="form-horizontal">
                          <p class="modal-label">same-day requests</p>
      ...
      <script type="text/javascript" src="<?php echo base_url(); ?>public/js/host/profile.js"></script>
      <script>
