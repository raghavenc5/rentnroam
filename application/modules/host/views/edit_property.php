        ...
        <div class="col-md-12">
            <div class="col-md-2"> <!-- required for floating -->
                ...
                <ul class="nav nav-tabs tabs-left">
                    ...
                    <li id="saveTab">
                        <a href="javascript:void(0);" id="save_all" class="button-pink btn btn-default no-margin-top" style="margin-bottom:2px">Save All</a>
                        ...
                        <div class="frm-body col-md-9 col-padding-no">
                            <form id="overview_form" name="overview_form" action="<?php echo base_url(); ?>host/saveOverview" method="post">
                                ...
                                <input type="hidden" name="overview_is_visited" class="is_visited" id="overview_is_visited" value="1"/>
                                 <input type="submit" class="button-pink btn btn-default pull-left" name='submit' id="save_overview" value="submit">
                            </form>
                        </div>
                       ...
                       <div class="frm-container">
                           ...
                           <div class="frm-body col-md-9 col-padding-no">
                               <!--<form id="manageRooms">-->
                                    ...
                                    <table id="addRooms" class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding-bottom:20px;"><img class="removeRoomsBtn remove_all_rooms" src="<?php echo base_url()?>public/images/closex.png" alt="Remove_All"></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                                <th></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <form name="manage_room_form" class="manage_room_forms" action="<?php echo site_url('/host/saveRoomDetails'); ?>" method="post">
                                                    ...
                                                    <td><a href="<?php echo site_url("/host/editproperty/$thisChildProperty->property_id/?referer=" . base64_encode(current_url() . '/?referer=' . $rawReferer)); ?>" class="button-pink btn btn-default pull-left edit_this_room">Edit</a></td>
                                                    <td class="remove">
                                ...
                                <input type="hidden" id="encoded_referer" name="encoded_referer" value="<?php echo base64_encode(current_url() . '/?referer=' . $rawReferer); ?>"/>
                           ...
                           <div class="frm-body col-md-9 col-padding-no">
                               <form id="fileupload">
                                    ...
                                    <div style="padding-left:0px;" class="col-md-12">
                                        <div class="errorHandler alert alert-danger" style="display:none;">
                                            <strong>Photos could not be uploaded. Please check below.</strong>
                                        </div>
                                    </div>
                                    <div style="padding-left:0px;" class="col-md-12">
                                    ...
                                    <div class="row fileupload-buttonbar">
                                        <div class="col-lg-7">
                                            <span class="button-pink btn btn-default pull-left fileinput-button">
                                    ...
                                    <input type="text" name="video_id" id="video_id" class="form-control"  placeholder="Enter your YouTube Video ID" value="<?php echo isset($propertyDetails->property_video) ? 'https://www.youtube.com/watch?v=' . $propertyDetails->property_video : ''; ?>"/>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="row" style="margin-top:50px;">
                                            <div class="col-sm-12">
                                                <div id='calendar'></div>
                                                <input type="hidden" name='property_id' id="post_approval_calendar_property_id" value="<?php echo $propertyId; ?>"/>
...
<!--                                    <div class="col-md-6 col-padding-no">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button class="button-pink btn btn-default no-margin-top pull-right" id="set_custom_price_button">Set Custom Price</button>
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <hr />
...
<!--                                            <div><p id="security_charge"></p></div>
                            ...
                            <div class="frm-body col-md-9 col-padding-no">
                                <form class="form-horizontal" id="listing_form" name="listing_form" action="<?php echo base_url(); ?>host/addListing" method="post">
                                    ...
                                    <div class="select-container">
                                        ...
                                        <div class="col-md-6 styled-select col-padding-no">
                                            <select id="room_type_id" name="listing[room_type_id]" class="form-control">
                                                ...
                                                ?>
                                                <option value="<?php echo $thisroomType->room_type_id; ?>" <?php echo ((isset($propertyDetails->room_type_id) && $propertyDetails->room_type_id) && $propertyDetails->room_type_id == $thisroomType->room_type_id) ? 'selected' : ''; ?>><?php echo $thisroomType->roomtype; ?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select> 
                                    ...
                                    <div class="select-container">
                                        ...
                                        <div class="col-md-6 styled-select col-padding-no">
                                            <select id="cancellation_policy_id" name="listing[cancellation_policy_id]" class="form-control">
                                                ...
                                                ?>
                                                <option value="<?php echo $thisPolicy->id; ?>" <?php echo ((isset($propertyDetails->cancellation_policy_id) && $propertyDetails->cancellation_policy_id) && $propertyDetails->cancellation_policy_id == $thisPolicy->id) ? 'selected' : ''; ?>><?php echo $thisPolicy->policy; ?></option>
                                                <?php
                                                endforeach;
                                                ?>
                                            </select>
                                    ...
                                    <div class="select-container" id="tags_container">
                                        ...
                                        <div class="panel-body styled-select col-padding-no">
                    ...
                    <div class="tab-pane" id="location">
                        <div class="frm-container">
                                ...
                                <form class="form-horizontal" id="location_form" name="location_form" action="<?php echo base_url(); ?>host/addLocation" method="post">
                                    ...
                                    <div class="select-container col-md-12 col-padding-no">
                                        ...
                                        <div class="col-md-6 styled-select margin-left-30">
                                             ...
                                             <input id="area" class="form-control" name="area" type="text" placeholder="Area" value="<?php echo (isset($propertyDetails->area) && $propertyDetails->area) ? filterDbOutput($propertyDetails->area) : ''; ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-12" style="padding-left:0px;">
                                    ...
                                    <div class="col-md-6 col-padding-no">
                                        <input type="text" id="zip" name="zip" class="form-control input-lg margin-top-30" placeholder="ZIP CODE" value="<?php echo (isset($propertyDetails->zip) && $propertyDetails->zip) ? filterDbOutput($propertyDetails->zip) : ''; ?>">
                                    </div>
                                    <div class="clearfix"></div>
                                    <hr/>
                                    <input id="pin_to_map" class="button-pink btn btn-default pull-left no-margin-top" onclick="codeAddress()" type="button" value="PIN IT TO MAP">
                            </div>
                            ...
                            <input class="button-pink btn btn-default pull-left no-margin-top" id="save_location" type="submit" value="SUBMIT">
                             </form>
                        </div>
                    </div>
                    <!-- location tab ends -->
...
<!-- calendar settings modal starts -->

<div id="calendar_settings" class="modal fade" tabindex="-1" data-width="350" style="display: none;">
    <div class="modal-body">
        <div class="row">
            <div class="col-md-12">
                <label>SAME-DAY REQUESTS</label>
                <select class="form-control" name="same_day_requests" id="same_day_requests">
                    <option value="1">I don't want same day requests...</option>
                </select>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-md-12">
                ...
                <select class="form-control" name="preparation_time" id="preparation_time">
                    <option value="1">Block two nights before and after...</option>
                </select>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-md-12">
                <label>DISTANT REQUESTS</label>
                <select class="form-control" name="distant_requests" id="distant_requests">
                    <option value="1">Guests appearing anytime are ok...</option>
                </select>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="input-group">                    
                    <input type="text" name="minimum_stay" id="minimum_stay" class="form-control" placeholder="2" aria-describedby="basic-addon1">
                    <span class="input-group-addon" id="basic-addon1">nights</span>
                </div>
            </div>
        </div>
        <br/>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="input-group">
                    <input type="text" name="maximum_stay" id="maximum_stay" class="form-control" placeholder="2" aria-describedby="basic-addon2">
        ...
        <div class="row">
            <div class="col-md-6">
                <a href="javascript:void(0);" class="button-pink btn btn-default no-margin-top">SAVE</a>
            </div>
            <div class="col-md-6">
                <a href="javascript:void(0);">Add a requirement for seasons or weekends</a>
            </div>
        </div>
    </div>
</div>

<!-- calendar settings modal ends -->
...
function codeAddress() {
    ...
    if (! errorFlag) {
//        var location = (! address1) ? '' : $.trim(address1);
//        location += (! address2) ? '' : ((! location) ? $.trim(address2) : (',' + $.trim(address2)));
//        location += (! area) ? '' : ((! location) ? $.trim(area) : (',' + $.trim(area)));
//        location += (! zip) ? '' : ((! location) ? $.trim(zip) : (',' + $.trim(zip)));
        ...
        geocoder.geocode({'address': location}, function(results, status) {
            if (status == google.maps.GeocoderStatus.OK) {
                ...
                $('#pin_to_map').after('<span class="help-block">Google geocode could not find your location at zip code: ' + location + '</span>');
            }
        });
    } else {
...
$('#location_tab').on('shown.bs.tab', function (e) {console.log(marker);
...
<script>
	$("#add_photo").click(function(e) {
        ...
        if (0 < $('#fileupload .successHandler').length) {
