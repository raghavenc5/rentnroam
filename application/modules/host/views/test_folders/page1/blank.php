...
<section id="container" > 
  ...
  <header class="header fixed-top clearfix"> 
      ...
      <div class="row">
    <!--logo start-->
    <div class="brand"> <a href="#" class="logo"> <img src="images/logo.png" alt=""> </a> 
      <!--
        ...
        <div class="nav notify-row pull-right" id="top_menu"> 
          ...
          <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <div class="avtaar-outer"> <img alt="" src="images/avatar1_small.jpg"> </div>
...
-->
          ...
          <ul class="nav top-menu pull-right">
            ...
            <li id="header_inbox_bar" class="dropdown"> <a data-toggle="dropdown" class="dropdown-toggle" href="#"> <i class="fa fa-envelope-o"></i> <span class="badge bg-important">4</span> </a>
              <ul class="dropdown-menu extended inbox">
                ...
                <li> <a href="#"> <span class="photo"><img alt="avatar" src="images/avatar-mini.jpg"></span> <span class="subject"> <span class="from">Jonathan Smith</span> <span class="time">Just now</span> </span> <span class="message"> Hello, this is an example msg. </span> </a> </li>
                <li> <a href="#"> <span class="photo"><img alt="avatar" src="images/avatar-mini-2.jpg"></span> <span class="subject"> <span class="from">Jane Doe</span> <span class="time">2 min ago</span> </span> <span class="message"> Nice admin template </span> </a> </li>
                <li> <a href="#"> <span class="photo"><img alt="avatar" src="images/avatar-mini-3.jpg"></span> <span class="subject"> <span class="from">Tasi sam</span> <span class="time">2 days ago</span> </span> <span class="message"> This is an example msg. </span> </a> </li>
                <li> <a href="#"> <span class="photo"><img alt="avatar" src="images/avatar-mini.jpg"></span> <span class="subject"> <span class="from">Mr. Perfect</span> <span class="time">2 hour ago</span> </span> <span class="message"> Hi there, its a test </span> </a> </li>
      ...
      <div class="help"> <img src="images/hepl-icon.png" alt=" help"> <span>HELP</span> </div>
      <div class="how-it-outer"> <img src="images/how-it.png" alt=" "> </div>
    </div>
          </div>
          </div>
  </header>
...
$baseUrl = 'http://localhost/rent_n_roam/trunk/rentnroam/host/create_property';
...
//echo $jobId;
$jsonDataObject = json_decode($jobId);
echo '<br/>';
echo '<br/>';

			
echo '<h1 >' .$jsonDataObject->message. '</h1>';
  ...
  <div class="container">
    <div class="row bor-bottom padding-bot-20">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
      	<div class="form-group relative-pos"> <img class="cup-img" src="images/cup.png" alt="cup" >
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-4">
      	...
      	<div class="form-group relative-pos"> <img class="cup-img" src="images/home.png" alt="cup" >
			 ...
			 <select id="exampleInputEmail2" name="room_type_id" class="form-control cup">	
		<?php
			...
			foreach($jsonDataObject as $option){
				echo '<option value=' . $option->roomtype . '>' . $option->roomtype . '</option>';
			}
      ...
      <!--	<div class="form-group relative-pos"> <img class="cup-img" src="images/door.png" alt="cup" >
       ...
       <h4 class="position-center private-room padding-bot-20">You’re renting a private room within a home.</h4>
       </div>
      ...
      <h3 class="heading-small">City</h3>
      	<div class="form-group relative-pos"> <img class="cup-img" src="images/loc.png" alt="cup" >
...
<script class="include" type="text/javascript" src="bs3/js/jquery.dcjqaccordion.2.7.js"></script> 

<!--common script init for all pages--> 
<script src="bs3/js/scripts.js"></script>
</body>
</html>
