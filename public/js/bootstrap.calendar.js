...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype.loadEvents = function () {
        if(!(this.events === null)){
            this.renderEvents(this.events, this.calendar);
        }
    };
    ...
    Plugin.prototype.renderDays = function () {
        ...
        var _html = '<tr>'+
                        '<th colspan="1" class="sel" id="last"><div class="arrow"><i class="fa fa-chevron-left"></i></div></th>'+
                        '<th colspan="5" class="sel"><h3 class="month"></h3></th>'+
                        '<th colspan="1" class="sel" id="next"><div class="arrow"><i class="fa fa-chevron-right"></i></div></th>'+
                    '</tr>'+"<tr>" +html+ "</tr>";
                        ...
                        if (target.is('.sel')){
                            switch(target.attr("id")){
                                case 'last':
                                    ...
                                    var date = getEventDate(prv);
                                    this.live_date = prv;
                                    $.ajax({
                                        url: base_url + 'host/bookings/fetchCalendarData/' + this.events.event[0].property_id + '/' + date,
                                        method: 'get',
                                        dataType: 'json',
